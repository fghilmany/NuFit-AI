...
fun String.toExerciseFlagOrNull(): ExerciseFlag? = when (this) {
    "flag_jantung" -> ExerciseFlag.HEALTH_HEART
    "flag_tekanan_darah" -> ExerciseFlag.HEALTH_BLOOD_PRESSURE
    "flag_diabetes" -> ExerciseFlag.HEALTH_DIABETES
    "flag_asma" -> ExerciseFlag.HEALTH_ASTHMA
    "flag_sendi" -> ExerciseFlag.HEALTH_JOINT
    ...
    "flag_asimetri_bahu" -> ExerciseFlag.POSTURAL_SHOULDER_ASYMMETRY
    "flag_asimetri_pinggul" -> ExerciseFlag.POSTURAL_HIP_ASYMMETRY
    ...
    "flag_balance_asimetri" -> ExerciseFlag.MOVEMENT_BALANCE_ASYMMETRY
    else -> null
}
