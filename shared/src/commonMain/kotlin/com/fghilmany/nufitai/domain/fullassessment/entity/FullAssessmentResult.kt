 ...
 * will expand later.
 *
 * [flagsPostural]/[movementFlags] are restricted in practice to [ExerciseFlag]'s POSTURAL_ and
 ...
 * [parQCategoryB] is restricted to the HEALTH_ subset, computed via
...
data class FullAssessmentResult(
    ...
    val parQCategoryB: Set<ExerciseFlag>,
    val hardStopFlagged: Boolean,
    val hardStopAcknowledgedAt: Instant?,
    val equipmentPreference: Set<EquipmentCategory>,
    val injuryHistory: Set<BodyArea>,
    val flagsPostural: Set<ExerciseFlag>,
    val movementFlags: Set<ExerciseFlag>,
